...
(defun cd-make-flyspell-overlay-return-mouse-stuff (ol)
  (overlay-put ol 'help-echo nil)
  (overlay-put ol 'keymap nil)
  (overlay-put ol 'mouse-face nil))

(advice-add 'make-flyspell-overlay :filter-return #'cd-make-flyspell-overlay-return-mouse-stuff)
...
;;;###autoload
(defun cd-flyspell-previous-word ()
